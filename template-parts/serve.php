...
<section class="serve">
    <div class="serve__columns">
        ...
        <div class="serve__text wow animate __animated animate__fadeInRight">
            <h2 class="serve__title"><?php echo carbon_get_post_meta($page_id, 'serve_title') ?><span><?php echo carbon_get_post_meta($page_id, 'serve_title_span') ?></span></h2>
